  ...
  module Acceptance
    module CommonTests
      ...
      module AttributesProperty
        ...
        def assert_attributes_on(host, resource_name, current_attributes_on, expected_attributes)
          current_attributes = current_attributes_on.call(host, resource_name)
  
          expected_attributes.each do |attribute, value|
            attribute_str = "attributes[#{resource_name}][#{attribute}]"
  ...
  MANIFEST
        ...
        def run_common_attributes_property_tests_on(
          ...
          step "Ensure that the #{resource} can be created with the specified attributes" do
            ...
            assert_attributes_on(host, resource_name, current_attributes_on, attributes)
          end

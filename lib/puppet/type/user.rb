...
module Puppet
  Type.newtype(:user) do
    ...
    # TODO: Retarget this commit at master. We're only doing 5.5.x in order to get the
    # recent changes to the KeyValue property made by the AIX User/Group refactoring.

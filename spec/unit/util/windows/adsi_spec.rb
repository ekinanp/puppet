  ...
  describe Puppet::Util::Windows::ADSI::User do
    ...
    describe "an instance" do
      ...
      describe 'userflags' do
        ...
        USERFLAGS = Puppet::Util::Windows::ADSI::User::USERFLAGS
        ...
        shared_examples 'userflag validation' do |method|
        ...
        describe '#set_userflags' do
          include_examples 'userflag validation', :set_userflags
          ...
          it 'should add the passed-in flags to the current set of userflags' do
            ...
            expected_userflags = userflags | USERFLAGS[input_flags[0]] | USERFLAGS[input_flags[1]]
        ...
        describe '#unset_userflags' do
          include_examples 'userflag validation', :unset_userflags
          ...
          it 'should remove the passed-in flags from the current set of userflags' do
            ...
            userflags = user['UserFlags']
            expected_userflags = 0 | USERFLAGS[:ADS_UF_HOMEDIR_REQUIRED] | USERFLAGS[:ADS_UF_LOCKOUT]

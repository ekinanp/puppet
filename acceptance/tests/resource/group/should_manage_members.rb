...
PS1
      ...
      # We should probably add Puppet::Util::POSIX.members_of to make this easier.
      # Maybe do this after https://github.com/puppetlabs/puppet/pull/7090 is merged?
